...
const (
	...
	DSN_MASTER    = "espeniel:anjgkrp@tcp(192.168.1.20)/ddaom?charset=utf8mb4&parseTime=True&loc=Local"
	DSN_SLAVE1    = "espeniel:anjgkrp@tcp(192.168.1.20)/ddaom?charset=utf8mb4&parseTime=True&loc=Local"
