...
const (
	...
	// real
	// HTTP_SERVER      = "https://s3.ap-northeast-2.amazonaws.com/image.ttaom.co.kr"
	// HTTP_PORT        = "3011"
	// HTTP_PORT_SSL    = "443"
	// DSN_MASTER       = "espeniel:anjgkrp@tcp(172.31.33.10:3306)/ddaom?charset=utf8mb4&parseTime=True&loc=Local"
	// DSN_SLAVE        = "espeniel:anjgkrp@tcp(localhost:3306)/ddaom?charset=utf8mb4&parseTime=True&loc=Local"
	// DSN_LOG1_MASTER  = "espeniel:anjgkrp@tcp(172.31.33.10:3306)/ddaom_user1?charset=utf8mb4&parseTime=True&loc=Local"
	// DSN_LOG1_SLAVE   = "espeniel:anjgkrp@tcp(localhost:3306)/ddaom_user1?charset=utf8mb4&parseTime=True&loc=Local"
	// DSN_LOG2_MASTER  = "espeniel:anjgkrp@tcp(172.31.33.10:3306)/ddaom_user2?charset=utf8mb4&parseTime=True&loc=Local"
	// DSN_LOG2_SLAVE   = "espeniel:anjgkrp@tcp(localhost:3306)/ddaom_user2?charset=utf8mb4&parseTime=True&loc=Local"
	...
	AWS_S3_SERVER   = "https://s3.ap-northeast-2.amazonaws.com/image.ttaom.co.kr"
)
...
func SetConnectionInfosParse() {
	jsonFile, _ := os.Open("define_conn_v1.json")
	defer jsonFile.Close()
	byteValue, _ := ioutil.ReadAll(jsonFile)
