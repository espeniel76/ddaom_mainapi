...
func MypageViewLive(req *domain.CommonRequest) domain.CommonResponse {
	...
	case 1:
		...
		ldb.Model(schemas.NovelStep3{}).Select("seq_novel_step3").Where("seq_novel_step1 = ?", seqNovelStep1).Scan(&seqNovelStep3)
		ldb.Model(schemas.NovelStep4{}).Select("seq_novel_step4").Where("seq_novel_step1 = ?", seqNovelStep1).Scan(&seqNovelStep4)
	...
	case 3:
		...
		ldb.Model(schemas.NovelStep3{}).Select("seq_novel_step1").Where("seq_novel_step3 = ?", seqNovelStep3).Scan(&seqNovelStep3)
		ldb.Model(schemas.NovelStep2{}).Select("seq_novel_step2").Where("seq_novel_step1 = ?", seqNovelStep1).Scan(&seqNovelStep2)
		ldb.Model(schemas.NovelStep4{}).Select("seq_novel_step4").Where("seq_novel_step1 = ?", seqNovelStep1).Scan(&seqNovelStep4)
	case 4:
		// 1,2,3
